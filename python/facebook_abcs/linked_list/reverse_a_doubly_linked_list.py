...
# Helpful resource with solution in Java that solves bugs from previous implementation https://www.hackerrank.com/challenges/reverse-a-doubly-linked-list/forum
def reverse2(head):
    curr = head
    temp = None
    newHead = None
